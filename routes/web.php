...
Route::get('/review/detail/{review}', [ReviewController::class, 'show'])->name(name: 'review.show');
Route::get('/review/input', [ReviewController::class, 'input'])->name(name: 'review.input');
